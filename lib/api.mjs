 ...
 * @returns {ApiRes}
 */
export function callJsonDBAction(req) {
    if (!routActionMap[req.actionName]) {
        logWarning(`Invalid actionName: ${req.actionName}`, "json-db-api :: serveDB");
...
function countAction(req) {
    const whoAmI = "json-db-api :: count";
...
function findOneAction(req) {
    const whoAmI = "json-db-api :: findOne";
    const {dbName, query, projection} = req;
...
function insertAction(req) {
    const whoAmI = "json-db-api :: insert";
...
function removeAction(req) {
    const whoAmI = "json-db-api :: remove";
...
function updateAction(req) {
    const whoAmI = "json-db-api :: update";
